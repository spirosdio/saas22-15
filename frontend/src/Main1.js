    ...
    <Container style={{}}>
      ...
      <Row>
        <Col className="leftRow" xs={4} >
          ...
          <p></p>
          <button className="button" onClick={displayInfo}>Refresh</button>
          
        </Col>

        <Col className="maincolumn" /*style={{ backgroundColor: "#507099" }}*/>
          ...
          <Row>
            ...
            <Col>
              <button className="button" onClick={download2}>Download Data</button>
            </Col>
          </Row>
          <div
            style={{
          ...
          <Row className="bottomrow" style={{ margin: "1%", margin: "1px" }}>
            <Col>
              <div style={{ color: "white", margin: "1vh" }} href="/Legal">
                Service Status: {status}
              </div>
            </Col>
            <Col style= {{margin : "1vh"}}>
              <DaysLeft></DaysLeft>
            </Col>
...
function DaysLeft() {
  ...
  if (manipulateTime == "00") {
    ...
    if(daysLeftNew==-1) daysLeftNew+=1;
